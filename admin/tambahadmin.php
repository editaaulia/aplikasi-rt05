...
<?php
 //proses simpan data
    ...
    if($proses=="simpan"){
        ...
        $simpan=mysqli_query($kon,"INSERT INTO tb_admin (nama_admin,username,password) 
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="tambahadmin.php">
                        <div class="form-group row">
                            <label for="nama_user" class="col-sm-2 
                    col-form-label">Nama</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" required autofocus id="nama_user" name="nama_admin">
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    col-form-label">Password</label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <a class="btn btn-danger" href="datauser.php" role="button">Batal</a>
                            </div>
                        </div>
                    </form>
